    ...
    <div class="body" >
        ...
        <?php if(isset($_GET['edit']) && $_GET['edit']==1) { ?>
            <form class="biodata" action="php/account-conn.php" metod="POST">
                ...
                <button class="button-icon top-right danger" onclick="window.location.href='accountLG.php'"><ion-icon name="close"></ion-icon></button>
                <br>
        ...
        <?php } else { ?>
            <div class="biodata">
                ...
                <button class="button-icon top-right" onclick="window.location.href='?edit=1'"><ion-icon name="pencil-outline"></ion-icon></button>
                <br>
                <label for="">Nama</label>
